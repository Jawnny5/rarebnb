...
//Delete reservation deletes a reservation by id
...
//InsertBlockForRoom inserts a room restriction(owner block) into DB
...
//DeleteBlockById deletes a block from DB.
